...
export class Animate {
  public static Attention_Seekers = {
  ...
  public static Bouncing_Entrances = {
  ...
  public static Fading_Entrances = {
  ...
  public static Rotating_Entrances = {
  ...
  public static Sliding_Entrances = {
